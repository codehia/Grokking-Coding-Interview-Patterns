## Find Sum of Three
# Given an array of integers `nums` and an integer `target`, return `True` if there exists three integers in `nums` whose sum is equal to `target`, otherwise return `False`.
